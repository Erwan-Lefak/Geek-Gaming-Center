  ...
  return (
    <div className="space-y-4">
      ...
      {product.stock > 0 ? (
        ...
        >
          {isAdding ? (
            <span className="flex items-center justify-center" style={{ color: '#ffffff' } as any}>
              <svg className="animate-spin -ml-1 mr-3 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" style={{ fill: 'none' } as any}>
                <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" style={{ fill: 'none' } as any}></circle>
                <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" style={{ fill: 'none' } as any}></path>
              </svg>
              Ajout en cours...
            </span>
          ) : showSuccess ? (
            <span className="flex items-center justify-center" style={{ color: '#ffffff' } as any}>
              <svg className="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{ fill: 'none' } as any}>
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" style={{ fill: 'none' } as any} />
              </svg>
              Ajouté au panier !
            </span>
          ) : (
            <span className="flex items-center justify-center" style={{ color: '#ffffff' } as any}>
              <svg className="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{ fill: 'none' } as any}>
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" style={{ fill: 'none' } as any} />
              </svg>
