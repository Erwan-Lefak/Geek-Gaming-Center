...
import { Mail, Phone, MapPin, Send, Gamepad2, Clock, MessageSquare, Facebook, Instagram } from 'lucide-react'
...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-purple-950 to-black mt-[8.5rem] md:mt-[6rem]">
      {/* Contact Content */}
      <section className="py-8 bg-gradient-to-br from-black via-purple-950 to-black">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="Réservation" className="bg-gray-900">Réservation</option>
                        <option value="Question générale" className="bg-gray-900">Question générale</option>
                        <option value="Événement / Anniversaire" className="bg-gray-900">Événement / Anniversaire</option>
                        <option value="Partenariat" className="bg-gray-900">Partenariat</option>
                        <option value="Réclamation" className="bg-gray-900">Réclamation</option>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-purple-600/20 to-pink-600/20 backdrop-blur-xl border border-purple-500/30 rounded-3xl p-6">
                ...
                <h3 className="text-lg font-bold text-white mb-2">Visitez-nous</h3>
                <p className="text-white/70 text-sm mb-4">
                  Vivez l&apos;expérience gaming ultime au coeur de Yaoundé. Réservation, gaming, restaurant, cinéma et plus encore !
                </p>
